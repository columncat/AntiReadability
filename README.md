# AntiReadability - 민감 정보 난독화 도구 (Sensitive Info Masking Tool)
...
### English
1. **Text Mix (Scramble)**
   - Replaces Korean syllables with random Korean, English with English, and digits with digits.
   - The exact character count and layout width are preserved, preventing visual shifts.
2. **Geometric Shapes**
   - Replaces characters with curated geometric symbols like `■`, `▲`, `●`, `★`, `♠` (U+25A0 ~ U+26FF).
...
## 🛠️ 설치 방법 (개발자 모드) / Installation (Developer Mode)
...
### English
1. Open any webpage or use the provided testbed [test.html](./test.html).
2. Right-click anywhere and select **'Start Sensitive Info Masking'** or click the **'Start Masking'** button in the extension popup.
...
5. When finished, click the **'Finish'** button to hide the toolbar and take a screenshot.
